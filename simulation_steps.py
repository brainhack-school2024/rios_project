...
from  ..simulate_mri import Volume, label
...
def test_create_dipole_kernel2(B0_dir, voxel_size, N, createInKspace):
...
D = test_create_dipole_kernel2(B0_dir, voxel_size, dims,"no")
